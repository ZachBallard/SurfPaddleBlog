        ...
        protected override void Seed(SurfPaddleBlog.Models.SurfPaddleBlogContext context)
        {
            ...
            context.Blogs.AddOrUpdate(
                ...
                new Models.Blog {Title="I am a seed post!", Author="Amy Duperson", AuthorPictureUrl= "https://headshotcrew.com/sites/default/files/styles/square-large/public/unknown-f.jpg?itok=ETYTyWCI",
                    ...
                    BigMiddleText="HIPSTER IPSUM!", SideBarTitle="Blah blah blah?", SideBarBody= "Disrupt shabby chic slow-carb sustainable, listicle stumptown pug truffaut. Hoodie distillery vice, bicycle rights 3 wolf moon pop-up beard poutine kickstarter chicharrones. Tattooed single-origin coffee tote bag.", AdPictureUrl= "https://longawkwardpause.files.wordpress.com/2016/01/bye-bye-hipster.jpg"}
                );
        }
    }
}
